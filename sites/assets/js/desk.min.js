...
/*
 *	/opt/bitnami/apps/erpnext/htdocs/frappe-bench/apps/frappe/frappe/public/js/lib/jquery/jquery-ui.min.js
 */
...
/*
 *	/opt/bitnami/apps/erpnext/htdocs/frappe-bench/apps/frappe/frappe/public/js/lib/Sortable.min.js
 */
...
/*
 *	/opt/bitnami/apps/erpnext/htdocs/frappe-bench/apps/frappe/frappe/public/js/lib/tag-it.min.js
 */
...
/*
 *	/opt/bitnami/apps/erpnext/htdocs/frappe-bench/apps/frappe/frappe/public/js/lib/bootstrap.min.js
 */
/*!
...
/*
 *	/opt/bitnami/apps/erpnext/htdocs/frappe-bench/apps/frappe/frappe/public/js/lib/moment/moment-with-locales.min.js
 */
...
/*
 *	/opt/bitnami/apps/erpnext/htdocs/frappe-bench/apps/frappe/frappe/public/js/lib/moment/moment-timezone-with-data.min.js
 */
//! moment-timezone.js
//! version : 0.3.1
//! author : Tim Wood
...
/*
 *	/opt/bitnami/apps/erpnext/htdocs/frappe-bench/apps/frappe/frappe/public/js/lib/socket.io.min.js
 */
...
return docfield[0];},with_doctype:function(doctype,callback){if(locals.DocType[doctype]){callback&&callback();}else{var cached_timestamp=null;if(localStorage["_doctype:"+doctype]){var cached_doc=JSON.parse(localStorage["_doctype:"+doctype]);cached_timestamp=cached_doc.modified;}
...
/*
 *	/opt/bitnami/apps/erpnext/htdocs/frappe-bench/apps/frappe/frappe/public/js/lib/md5.min.js
 */
...
var audio=$("#sound-"+name)[0];audio.volume=audio.getAttribute("volume");audio.play();}catch(e){console.log("Cannot play sound",name,e);}}};;frappe.provide("frappe.tools");frappe.tools.downloadify=function(data,roles,title){if(roles&&roles.length&&!has_common(roles,user_roles)){msgprint(__("Export not allowed. You need {0} role to export.",[frappe.utils.comma_or(roles)]));return;}
var csv_data=frappe.tools.to_csv(data);var blob_object=new Blob([csv_data],{type:'text/csv'});var blob_url=URL.createObjectURL(blob_object);var a=document.createElement('a');a.download=title+'.csv';a.href=blob_url;document.body.appendChild(a);a.click();document.body.removeChild(a);};frappe.markdown=function(txt){if(!frappe.md2html){frappe.require('assets/frappe/js/lib/markdown.js');frappe.md2html=new Showdown.converter();}
